...
public class PackagePanel : UIPopPanelBase
{
    ...
    {
        // 根据UID查找对应的物品本地数据
        PackageLocalItem localItem = LegacyPackageManager.Instance.GetPackageLocalItemByUId(chooseUID);
    ...
    private void RefreshScroll()
    {
        ...
        foreach (PackageLocalItem localData in LegacyPackageManager.Instance.GetSortPackageLocalData())
        {
            // 实例化物品预制体
    ...
    private void OnDeleteConfirm()
    {
        ...
        // 调用GameManager删除物品
        LegacyPackageManager.Instance.DeletePackageItems(this.deleteChooseUid);
